...
argglobal
%argdel
$argadd src\ReplicatedStorage\Themes.lua
tabnew
tabrewind
...
wincmd w
argglobal
if bufexists("C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Themes.lua") | buffer C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Themes.lua | else | edit C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Themes.lua | endif
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((28 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 232 - ((37 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
232
...
badd +278 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Util.lua
badd +8 C:\Data\Roblox\Places\PetShopPanic\src\ServerScriptService\Game.server.lua
...
badd +8 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Gui\ProgressBarFactory.lua
...
badd +100 C:\Data\Roblox\Places\PetShopPanic\src\ServerScriptService\MapManager.lua
