...
argglobal
%argdel
$argadd src\ReplicatedStorage\Settings.lua
tabnew
tabrewind
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 118 + 134) / 269)
exe '2resize ' . ((&lines * 29 + 30) / 61)
exe 'vert 2resize ' . ((&columns * 150 + 134) / 269)
exe '3resize ' . ((&lines * 28 + 30) / 61)
exe 'vert 3resize ' . ((&columns * 150 + 134) / 269)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Gui\ProgressBarFactory.lua") | buffer C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Gui\ProgressBarFactory.lua | else | edit C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Gui\ProgressBarFactory.lua | endif
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("C:\Data\Roblox\Places\PetShopPanic\src\StarterGui\PlayerCamera.client.lua") | buffer C:\Data\Roblox\Places\PetShopPanic\src\StarterGui\PlayerCamera.client.lua | else | edit C:\Data\Roblox\Places\PetShopPanic\src\StarterGui\PlayerCamera.client.lua | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <F1> :call xolox#lua#help()
nmap <buffer> K :call xolox#lua#help()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((15 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
exe 'vert 3resize ' . ((&columns * 150 + 134) / 269)
tabnext
edit C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Util.lua
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 278 - ((23 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
278
...
badd +96 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\TrashBins\TrashBin.lua
badd +19 C:\Data\Roblox\Places\PetShopPanic\src\StarterPlayer\StarterPlayerScripts\InitializePlayer.client.lua
badd +1 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Factories\Factory.lua
badd +232 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Util.lua
badd +343 C:\Data\Roblox\Places\PetShopPanic\src\ServerScriptService\Game.server.lua
...
badd +1 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Consumers\Consumer.lua
badd +15 C:\Data\Roblox\Places\PetShopPanic\src\StarterGui\PlayerCamera.client.lua
...
badd +62 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Gui\ProgressBarFactory.lua
badd +1 C:\Data\Roblox\Places\PetShopPanic\src\ServerScriptService\InitializePlayer.server.lua
badd +2 C:\Data\Roblox\Places\PetShopPanic\src\ReplicatedStorage\Settings.lua
